/**
 * ShellNotesTab - Markdown notes editor for shell context sidebar
 */
...
interface ShellNotesTabProps {
  shellId: string;
}

export function ShellNotesTab({ shellId }: ShellNotesTabProps): React.ReactElement {
  const { notes, isLoading, isError, error, updateNotes, isUpdatingNotes } = useShellContext(shellId);
