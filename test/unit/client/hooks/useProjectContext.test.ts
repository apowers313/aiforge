/**
 * Tests for useProjectContext hook - project context (todos + notes) management
 */
...
describe('useProjectContext', () => {
  ...
  describe('fetching context', () => {
    it('fetches project context on mount', async () => {
      ...
      const { result } = renderHook(() => useProjectContext('project-1'), {
    ...
    it('returns empty context for project with no data', async () => {
      mockFetch.mockResolvedValueOnce({
        ok: true,
        status: 200,
  ...
  describe('addTodo', () => {
    it('adds todo via API', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        expect.stringContaining('/api/projects/project-1/todos'),
  ...
  describe('toggleTodo', () => {
    it('toggles todo completion via API', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        expect.stringContaining('/api/projects/project-1/todos/1'),
        expect.objectContaining({
          method: 'PUT',
  ...
  describe('deleteTodo', () => {
    it('deletes todo via API', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        '/api/projects/project-1/todos/1',
  ...
  describe('updateNotes', () => {
    it('updates notes via API', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        expect.stringContaining('/api/projects/project-1/notes'),
        expect.objectContaining({
          method: 'PATCH',
  ...
  describe('clearCompleted', () => {
    it('clears completed todos via API', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        expect.stringContaining('/api/projects/project-1/todos/clear-completed'),
  ...
  describe('reorderTodos', () => {
    it('reorders todos via API', async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        expect.stringContaining('/api/projects/project-1/todos/reorder'),
        expect.objectContaining({
          method: 'PUT',
